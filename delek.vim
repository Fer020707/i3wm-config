...
hi Constant   cterm=NONE ctermfg=Green   gui=NONE guifg=green3
hi Identifier cterm=NONE ctermfg=Cyan    gui=NONE guifg=cyan4
hi PreProc    cterm=NONE ctermfg=Yellow gui=NONE guifg=magenta3
hi Special    cterm=NONE ctermfg=Red    gui=NONE guifg=deeppink
hi Statement  cterm=bold ctermfg=Magenta	     gui=bold guifg=blue
